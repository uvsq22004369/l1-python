...
PionV = Canevas.create_oval(PosX1-10,PosY1-10,PosX1+10,PosY1+10,width=2,outline='black',fill='green')#, select= False)
PionR = Canevas.create_oval(PosX2-10,PosY2-10,PosX2+10,PosY2+10,width=2,outline='black',fill='red')#, select= False)
PionB = Canevas.create_oval(PosX3-10,PosY3-10,PosX3+10,PosY3+10,width=2,outline='black',fill='blue')#, select= False)
PionJ = Canevas.create_oval(PosX4-10,PosY4-10,PosX4+10,PosY4+10,width=2,outline='black',fill='yellow')#, select= False)
Canevas.focus_set()
